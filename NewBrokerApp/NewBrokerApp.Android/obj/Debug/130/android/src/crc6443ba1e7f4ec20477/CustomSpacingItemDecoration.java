...
public class CustomSpacingItemDecoration
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("NewBrokerApp.Droid.Renders.CustomSpacingItemDecoration, NewBrokerApp.Android", CustomSpacingItemDecoration.class, __md_methods);
	}


	public CustomSpacingItemDecoration ()
	{
		super ();
		if (getClass () == CustomSpacingItemDecoration.class) {
			mono.android.TypeManager.Activate ("NewBrokerApp.Droid.Renders.CustomSpacingItemDecoration, NewBrokerApp.Android", "", this, new java.lang.Object[] {  });
		}
	}
