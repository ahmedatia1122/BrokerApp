...
namespace NewBrokerApp.Views.Company.PropertiesAdsCompany
{
    ...
    public partial class AddBuildingDetailsPage : ContentPage
    {
        ...
        private bool IsValidPropertyDetails()
        {
            ...
            if (viewModel.AdvertisementModel.NumUnits == null)
            {
                App.Current.MainPage.DisplayAlert("", AppResources.enterPropertyNumUnits, AppResources.ok);
                return false;
            }
            if (viewModel.AdvertisementModel.NumPartitions == null)
            {
